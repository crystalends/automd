...
test("warranty layout is fluid and has a content-driven mobile reflow", () => {
  ...
  assert.match(styles, /\.warranty-process-card__list-item\s*\{[^}]*min-height:\s*39px[^}]*warranty-process-pattern\.png[^}]*305px 39px/s);
  assert.match(styles, /@media \(max-width: 1199px\)[\s\S]*?\.warranty-process-card__list-item\s*\{[^}]*height:\s*auto[^}]*min-height:\s*39px/s);
  ...
  assert.match(styles, /\.warranty-return-card__list-item\s*\{[^}]*min-height:\s*64px[^}]*warranty-return-pattern-positive\.png/s);
  assert.match(styles, /\.warranty-return-card__list--negative :where\(\.warranty-return-card__list-item\)\s*\{[^}]*warranty-return-pattern-negative-short\.png/s);
  ...
  assert.match(styles, /\.warranty-exclusions__list-item\s*\{[^}]*display:\s*flex[^}]*min-height:\s*24px/s);
  assert.match(styles, /\.warranty-exclusions__list-item\.warranty-check-list__item::before\s*\{[^}]*content:\s*none/s);
